...
;;;;;;  vm-recover-folder) "vm" "vm.el" (18015 17112))
;;; Generated autoloads from vm.el

(autoload (quote vm-recover-folder) "vm" "\
...
;;;;;;  "vm-avirtual" "vm-avirtual.el" (18015 17111))
...
;;;;;;  "vm-crypto" "vm-crypto.el" (18015 17111))
...
;;;;;;  vm-delete-message) "vm-delete" "vm-delete.el" (18015 17111))
...
;;;;;;  "vm-digest" "vm-digest.el" (18015 17111))
...
;;;;;;  vm-edit-message) "vm-edit" "vm-edit.el" (18015 17111))
...
;;;;;;  vm-unread-message) "vm-folder" "vm-folder.el" (18015 17111))
...
;;;;;;  "vm-grepmail" "vm-grepmail.el" (18015 17111))
...
;;;;;;  "vm-license" "vm-license.el" (18015 17111))
...
;;;;;;  vm-clear-all-marks) "vm-mark" "vm-mark.el" (18015 17111))
...
;;;;;;  "vm-mime" "vm-mime.el" (18015 17111))
...
;;;;;;  "vm-motion" "vm-motion.el" (18015 17111))
...
;;;;;;  "vm-page" "vm-page.el" (18015 17111))
...
;;;;;;  "vm-pcrisis" "vm-pcrisis.el" (18015 17111))
...
(custom-autoload (quote vm-postponed-attribute) "vm-pine" t)

(autoload (quote vm-summary-function-p) "vm-pine" "\
...
;;;;;;  "vm-ps-print" "vm-ps-print.el" (18015 17112))
...
;;;;;;  vm-do-reply) "vm-reply" "vm-reply.el" (18015 17112))
...
;;;;;;  vm-rfaddons-infect-vm) "vm-rfaddons" "vm-rfaddons.el" (18015
;;;;;;  17112))
...
(autoload (quote vm-fill-long-lines-in-reply) "vm-rfaddons" "\
Not documented

\(fn)" t nil)

(autoload (quote vm-fill-paragraphs-containing-long-lines-toggle) "vm-rfaddons" "\
Not documented

\(fn)" t nil)

(autoload (quote vm-unfill-paragraphs-containing-long-lines-faster) "vm-rfaddons" "\
Sometimes filling long lines is the wrong thing!
Call this function, if you want to see the message unfilled.

\(fn)" t nil)

(autoload (quote vm-fill-paragraphs-containing-long-lines-faster) "vm-rfaddons" "\
Not documented

\(fn WIDTH START END)" nil nil)

(autoload (quote vm-fill-paragraphs-containing-long-lines-by-longlines) "vm-rfaddons" "\
...
(defvar vm-mime-all-attachments-directory (if (boundp (quote vm-mime-attachment-save-directory)) vm-mime-attachment-save-directory (expand-file-name "~/Attachments")) "\
*Directory to where the attachments should go or come from.")

(custom-autoload (quote vm-mime-all-attachments-directory) "vm-rfaddons" t)
...
(autoload (quote vm-mime-delete-all-attachments) "vm-rfaddons" "\
Not documented

\(fn &optional COUNT)" t nil)

(autoload (quote vm-mime-save-all-attachments) "vm-rfaddons" "\
...
(autoload (quote vm-mime-encode-headers) "vm-rfaddons" "\
...
(autoload (quote vm-summary-function-S) "vm-rfaddons" "\
...
(autoload (quote vm-summary-function-A) "vm-rfaddons" "\
...
;;;;;;  vm-pipe-message-to-command vm-save-message-sans-headers vm-save-message-to-local-folder
;;;;;;  vm-save-message vm-auto-archive-messages vm-auto-select-folder
;;;;;;  vm-match-data) "vm-save" "vm-save.el" (18015 17112))
...
;;;;;;  vm-move-message-forward) "vm-sort" "vm-sort.el" (18015 17112))
...
;;;;;;  vm-summarize) "vm-summary" "vm-summary.el" (18015 17112))
...
;;;;;;  "vm-summary-faces" "vm-summary-faces.el" (18015 17112))
...
;;;;;;  "vm-thread" "vm-thread.el" (18015 17112))
...
;;;;;;  "vm-toolbar" "vm-toolbar.el" (18015 17112))
...
;;;;;;  "vm-undo" "vm-undo.el" (18015 17112))
...
;;;;;;  "vm-virtual" "vm-virtual.el" (18015 17112))
...
;;;***

;;;### (autoloads nil nil ("vm-autoload.el" "vm-build.el" "vm-easymenu.el"
;;;;;;  "vm-macro.el" "vm-menu.el" "vm-message.el" "vm-minibuf.el"
;;;;;;  "vm-misc.el" "vm-pgg.el" "vm-revno.el" "vm-serial.el" "vm-startup.el"
;;;;;;  "vm-user.el" "vm-vars.el" "vm-version.el") (18416 29106 202723))
